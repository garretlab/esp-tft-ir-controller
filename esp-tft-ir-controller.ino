...
void setControllerCommon1() {
  ...
  buttons.addButton(0, yp0, 32, 32, 60, 30, downArrow, 0x0000, 0xffff, NULL, 0, 0x0000, NULL, nec, 0x40bf, 1, 0x0f); // input down
  buttons.addButton(192, yp0, 32, 32, 60, 30, upArrow, 0x0000, 0xffff, NULL, 0, 0x0000, NULL, nec, 0x40bf, 1, 0x3a); // input up
}
